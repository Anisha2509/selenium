...
class GithubWatchRepoTest(unittest.TestCase):
    ...
    def test_github_watch_repo_annonymous_user_redirects_to_login(self):
       ...
       watch_button=driver.find_element_by_partial_link_text(u"Watch").click() driver.save_screenshot('test_github_watch_repo_annonymous_user_redirects_to_login.png')
